(function() {
	var socket = new WebSocket("ws://localhost:8080/websocket/actions/chat");
	...
	function printMessage(data) {
		...
		var chatMessageTimestamp = $('<div>').addClass('chatMessageTimestamp').text(timestamp);
		var chatMessageText = $('<div>').addClass('chatMessageText').text(data.message);
